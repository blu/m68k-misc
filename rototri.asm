...
vert_extrema:
	...
	bge	minx_donee
	move.w	d4,box_min+r2_x(a4)
minx_donee:
	cmp.w	box_max+r2_x(a4),d4
	ble	maxx_donee
	move.w	d4,box_max+r2_x(a4)
maxx_donee:
	...
	; update y-bounds
	cmp.w	box_min+r2_y(a4),d6
	bge	miny_donee
	move.w	d6,box_min+r2_y(a4)
miny_donee:
	cmp.w	box_max+r2_y(a4),d6
	ble	maxy_donee
	move.w	d6,box_max+r2_y(a4)
maxy_donee:
	cmpa.l	a2,a0
	bcs	vert_extrema
	bra	xform_done
...
maxx_done:
	...
	; update y-bounds
	cmp.w	box_min+r2_y(a4),d4
	bge	miny_done
	move.w	d4,box_min+r2_y(a4)
miny_done:
	cmp.w	box_max+r2_y(a4),d4
	ble	maxy_done
	move.w	d4,box_max+r2_y(a4)
maxy_done:
	cmpa.l	a2,a0
	bcs	vert
