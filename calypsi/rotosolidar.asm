...
; alt_memset (numerical, optional): select memset routine for use by tri routine
	...
	#ifdef do_persp
	#ifndef do_clip
	#error "do_persp requires do_clip"
	#endif
	#endif
...
; struct box
box_min	.equ	0 ; word x2 ; r2
box_max	.equ	4 ; word x2 ; r2
box_size .equ	8
...
; struct idx
idx_p0	.equ	0 ; word x1
idx_p1	.equ	2 ; word x1
idx_p2	.equ	4 ; word x1
idx_size .equ	6
...
; struct pb
pb_p0	.equ	0  ; word x2 ; r2
pb_e01	.equ	4  ; word x2 ; r2
pb_e02	.equ	8  ; word x2 ; r2
pb_area	.equ	12 ; long x1
pb_size .equ	16
...
tri_idx_0:
	; z-axis faces
	.word	0*r3_size, 1*r3_size, 2*r3_size
	.word	2*r3_size, 1*r3_size, 3*r3_size

	.word	4*r3_size, 5*r3_size, 6*r3_size
	.word	6*r3_size, 5*r3_size, 7*r3_size

	; y-axis faces
	.word	7*r3_size, 2*r3_size, 6*r3_size
	.word	6*r3_size, 2*r3_size, 3*r3_size

	.word	0*r3_size, 5*r3_size, 1*r3_size
	.word	1*r3_size, 5*r3_size, 4*r3_size

	; x-axis faces
	.word	4*r3_size, 6*r3_size, 1*r3_size
	.word	1*r3_size, 6*r3_size, 3*r3_size

	.word	7*r3_size, 5*r3_size, 2*r3_size
	.word	2*r3_size, 5*r3_size, 0*r3_size
tri_obj_0:
	#ifdef do_clip
	.word	-29, -29,  29
	.word	 29, -29,  29
